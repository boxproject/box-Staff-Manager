...
- (void)viewDidLoad {
    ...
    NSDictionary *dict = @{
                           @"data":@[
                                   @{@"titleName":@"王钥匙", @"subTitle":@"0xb2ed7ceaebd98686cb9310a32d93e91044a580a6"},
                                   @{@"titleName":@"张三", @"subTitle":@"0xb2ed7ceaebd98686cb9310a32d93e91044a580a6"},
                                   @{@"titleName":@"李四", @"subTitle":@"0xb2ed7ceaebd98686cb9310a32d93e91044a580a6"},
                                   @{@"titleName":@"王钥匙", @"subTitle":@"0xb2ed7ceaebd98686cb9310a32d93e91044a580a6"},
                                   @{@"titleName":@"王钥匙", @"subTitle":@"0xb2ed7ceaebd98686cb9310a32d93e91044a580a6"},
                                   @{@"titleName":@"王钥匙", @"subTitle":@"0xb2ed7ceaebd98686cb9310a32d93e91044a580a6"} 
                                   ]
    ...
    for (NSDictionary *dataDic in dict[@"data"]) {
        SearchMenberModel *model = [[SearchMenberModel alloc] initWithDict:dataDic];
...
{
    SearchMenberModel *model = self.sourceArray[indexPath.row];
    self.menberBlock(model.titleName) ;
